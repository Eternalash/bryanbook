...
![](https://tech.meituan.com/img/redblack-tree/tree-all.png "BST")
...
while(true){
   if(root==null)break;
   parent = root;
   if(node.value.compareTo(root.value)
<
=0){
      root = root.left;  
   }else{
...
![](https://tech.meituan.com/img/redblack-tree/bst-tree-remove.png "BST remove")
...
![](https://tech.meituan.com/img/redblack-tree/rotate-all.png "BST remove")
...
![](https://tech.meituan.com/img/redblack-tree/insert-case1.png "插入修复case 1")

#### 插入操作-case 2 {#-case-2}

case 2的操作是将B节点进行右旋操作，并且和父节点A互换颜色。通过该修复操作RBTRee的高度和颜色都符合红黑树的定义。如果B和C节点都是右节点的话，只要将操作变成左旋就可以了。  
![](https://tech.meituan.com/img/redblack-tree/insert-case2.png "插入修复case 2")
...
![](https://tech.meituan.com/img/redblack-tree/insert-case3.png "插入修复case 3")
...
![](https://tech.meituan.com/img/redblack-tree/remove-case1.png "删除情况1")
...
![](https://tech.meituan.com/img/redblack-tree/remove-case2.png "删除情况2")
...
![](https://tech.meituan.com/img/redblack-tree/remove-case3.png "删除情况3")
...
![](https://tech.meituan.com/img/redblack-tree/remove-case4.png "删除情况4")
